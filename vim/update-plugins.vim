...
<html lang="en">
  ...
  <title>config/update-plugins.vim at master · carlsverre/config · GitHub</title>
  ...
  <meta name="request-id" content="94A0:35D9:2731DEF:3B145EC:5AA7388C" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="94A0:35D9:2731DEF:3B145EC:5AA7388C" name="octolytics-dimension-request_id" /><meta content="sea" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" />
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="html-safe-nonce" content="377ae66320c92273125417fe2dab3c3cb3e38f63">
  ...
  <meta content="82591" name="octolytics-dimension-user_id" /><meta content="carlsverre" name="octolytics-dimension-user_login" /><meta content="61771580" name="octolytics-dimension-repository_id" /><meta content="carlsverre/config" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="61771580" name="octolytics-dimension-repository_network_root_id" /><meta content="carlsverre/config" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
    ...
    <link rel="canonical" href="https://github.com/carlsverre/config/blob/master/nvim/update-plugins.vim" data-pjax-transient>
...
<link rel="manifest" href="/manifest.json" crossOrigin="use-credentials">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/carlsverre/config/search" class="js-site-search-form" data-scoped-search-url="/carlsverre/config/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/carlsverre/config/blob/master/nvim/update-plugins.vim" class="header-search-scope no-underline">This repository</a>
      <input type="text"
        ...
        <span class="d-inline-block">
            <div class="HeaderNavlink px-0 py-2 m-0">
              <a class="text-bold text-white no-underline" href="/login?return_to=%2Fcarlsverre%2Fconfig%2Fblob%2Fmaster%2Fnvim%2Fupdate-plugins.vim" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a href="/carlsverre/config/blob/d1794f43b55c8c8e5b246543163d068541121515/nvim/update-plugins.vim" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:45b7f4b3220269f1f9c6e2deddc0a9db -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/carlsverre/config/blob/master/nvim/update-plugins.vim"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/carlsverre/config/commit/8f63d0242242daa28f07e7feb120ba2c3601f4a1" data-pjax>
          8f63d02
        </a>
        <relative-time datetime="2018-01-24T23:14:46Z">Jan 24, 2018</relative-time>
      </span>
      <div>
        ...
        <a href="/carlsverre" class="user-mention" rel="author">carlsverre</a>
          <a href="/carlsverre/config/commit/8f63d0242242daa28f07e7feb120ba2c3601f4a1" class="message" data-pjax="true" title="updating plugins">updating plugins</a>
      </div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/carlsverre/config/raw/master/nvim/update-plugins.vim" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/carlsverre/config/blame/master/nvim/update-plugins.vim" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/carlsverre/config/commits/master/nvim/update-plugins.vim" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
  ...
  <div itemprop="text" class="blob-wrapper data type-vim-script">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-code blob-code-inner js-file-line"><span class="pl-k">let</span> opts <span class="pl-k">=</span> {}</td>
      </tr>
      <tr>
        <td id="L2" class="blob-num js-line-number" data-line-number="2"></td>
        <td id="LC2" class="blob-code blob-code-inner js-file-line"><span class="pl-k">let</span> opts.path_to_nixpkgs <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#39;</span>/etc/nixos/nixpkgs<span class="pl-pds">&#39;</span></span></td>
      </tr>
      <tr>
        <td id="L3" class="blob-num js-line-number" data-line-number="3"></td>
        <td id="LC3" class="blob-code blob-code-inner js-file-line"><span class="pl-k">let</span> opts.cache_file <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#39;</span>.cache<span class="pl-pds">&#39;</span></span></td>
      </tr>
      <tr>
        <td id="L4" class="blob-num js-line-number" data-line-number="4"></td>
        <td id="LC4" class="blob-code blob-code-inner js-file-line"><span class="pl-k">let</span> opts.plugin_dictionaries <span class="pl-k">=</span> <span class="pl-en">map</span>(<span class="pl-en">readfile</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>vim-plugins<span class="pl-pds">&quot;</span></span>), <span class="pl-s"><span class="pl-pds">&#39;</span>eval(v:val)<span class="pl-pds">&#39;</span></span>)</td>
      </tr>
      <tr>
        <td id="L5" class="blob-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">call</span> <span class="pl-en">nix#ExportPluginsForNix</span>(opts)</td>
      </tr>
</table>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a href="/carlsverre/config/blame/d1794f43b55c8c8e5b246543163d068541121515/nvim/update-plugins.vim" class="dropdown-item js-update-url-with-hash" id="js-view-git-blame">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.14342s from unicorn-1390517522-234pd">GitHub</span>, Inc.</li>
