      ...
      { description = "DHCP Client";
        ...
        serviceConfig = let
          ...
          in { Type = "forking";
            ...
            ExecStart = "@${phys-aware} dhcpcd ${dhcpcd}/sbin/dhcpcd -w --quiet ${optionalString cfg.persistent "--persistent"} --config ${dhcpcdConf} ${concatStringsSep " " config.networking.wireless.interfaces}";
